...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    dis_city = make_city('dis_city', lat, lon)
    dis_a = distance(city_a, dis_city)
    dis_b = distance(city_b, dis_city)
    if dis_a < dis_b:
...
def riffle(deck):
    ...
    """
    "*** YOUR CODE HERE ***"
    return [(lambda i: deck[i//2] if i % 2 == 0 else deck[len(deck)//2 + (i-1)//2])(i) for i in range(len(deck))]
